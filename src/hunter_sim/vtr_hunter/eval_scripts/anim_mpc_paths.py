...
def main(file_path, pose_graph_path):
    ...
    follow_plot = ax.plot(matched_follower.iloc[0]['x'], matched_follower.iloc[0]['y'], color='green', label="Follower", zorder=4)[0]
    ...
    ax_offset.plot(leader['t'].to_numpy() * 1e-9, path_offset_follower, label="Follower Path Offset", color="green")
